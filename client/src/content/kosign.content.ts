// Generated from kosign.md — edit copy there, then update this file to match.

export const meta = {
  title: "KOSIGN",
  subtitle: "Launching a self-serve publishing platform for independent songwriters",
  client: "Kobalt Music Group",
  year: "2022–2023",
  role: "Lead Product Designer",
  tags: ["Product Design", "Strategy", "0→1"],
};

export const proofPoints = [
  {
    value: "93%",
    label: "Acceptance to Activation",
    note: "93% reduction in days to activation since launch",
  },
  {
    value: "90%",
    label: "Activation to submission",
    note: "90% reduction in days to first submission since launch",
  },
  {
    value: "91%",
    label: "Acceptance to submission",
    note: "91% reduction in days to first submission since launch",
  },
  {
    value: "32%",
    label: "Metadata quality",
    note: "32% improvement in ISRC coverage since launch",
  },
  {
    value: "100%",
    label: "Support requests",
    note: "100% removal of post-submission support requests",
  },
];
...
export const sections = {
  ...
  myRole: [
    "I was responsible for the end-to-end experience strategy and execution for KOSIGN, ultimately made possible by working hand in hand with product management and engineering to shape a path to market, building on the music expertise our business possesses.",
  ...
  strategyDecisions: [
    ...
    "We identified the post-acceptance journey as a key moment early on, and focused on increasing intuition and reducing friction wherever possible to reduce procrastination through perceived effort, and drop-off through confusion",
    ...
    "We re-architected the song submission flow into focused, low-friction steps, before eventually augmenting it with optionality for input methods (link submission and reactive suggestions)",
  ],
