...
export const sections = {
  ...
  realProblem: [
    "Publishing isn't sexy — it's complex, misunderstood, and built on delayed gratification. And for most writers and artists, the challenge isn't just choosing the right solution — it's being aware that there is a problem at all.",
  ...
  strategyDecisions: [
    "The website initially acted as a sales and demand tool, majoring on increasing the quantity — not quality — of applications",
    "The post-acceptance journey was always key, and was prioritised from a design perspective to increase intuition and reduce friction that might increase perceived effort or drop-off",
    "A newly standardised contract was summarised to reduce friction in a key moment in the onboarding journey",
